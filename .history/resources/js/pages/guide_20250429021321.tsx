                        ...
                        <div className="p-6">
                            ...
                            {showVideo && (
                                <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
                                    <div className="bg-white rounded-lg overflow-hidden shadow-lg w-full max-w-2xl relative">
                                    ...
                                    <div className="relative" style={{ paddingTop: '56.25%' /* 16:9 Aspect Ratio */ }}>
                                        ...
                                        src="" // 🔥 your client will put YouTube embed link here later
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 focus:outline-none focus:border-red-700 focus:ring focus:ring-red-200 active:bg-red-700 transition ease-in-out duration-150"
                                    >
                                    Watch Tutorial
                                    </button>
                                </div>
